            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        @endif
                    <form action="{{route('sub-update-category')}}" method="post" class="">
                        @csrf
                        <input type="hidden" name="id" value="{{$subCategory->id}}">
                         <div class="card-body">
                            <div class="form-group">
                                <label for="nf-email" class=" form-control-label">Name</label>
                                <input type="name" id="nf-email" name="name" placeholder="Enter name.." 
                            ...
                            <div class="form-group">
                                ...
                                <input type="slug" id="nf-password" name="slug" placeholder="Enter slug.." 
                                    class="form-control" value="{{$subCategory->slug}}">
                                @error('slug')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
